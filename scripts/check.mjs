...
const required=['index.html','styles.css','app.js','models.js','assets/univalle-logo.jpg'];
for(const file of required){if(!fs.statSync(path.join('dist',file)).size)throw new Error('Archivo vacío: '+file);}
for(const file of ['app.js','models.js'])execFileSync(process.execPath,['--check',path.join('dist',file)]);
